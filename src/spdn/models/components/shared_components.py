"""
Shared neural network components for SPDN models.
...
class ChannelAttention(nn.Module):
    ...
    def __init__(
        self, channels: int, reduction_ratio: int = 16, scale_factor: float = 1.0
    ):
...
class DilatedConvBlock(nn.Module):
    ...
    def __init__(
        self, in_channels: int, out_channels: int, dilation_rates: list = [1, 2, 4]
    ):
