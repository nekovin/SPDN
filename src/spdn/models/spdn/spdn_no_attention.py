...
class SPDNNoAttention(nn.Module):
    """
    ...
    def __init__(self, input_channels=1, feature_dim=32, depth=5, block_depth=3):
        ...
        """
        super(SPDNNoAttention, self).__init__()
    ...
    def __repr__(self):
        return f"SPDNNoAttention(input_channels={self.input_channels}, feature_dim={self.feature_dim}, depth={self.depth}, block_depth={self.block_depth})"
...
def get_spdn_model_no_attention(checkpoint_path):
