"""
Unified loss functions for SPDN training.

This module consolidates all loss functions used in the SPDN framework
...
class DiceBCELoss(nn.Module):
    ...
    def __init__(
        self, dice_weight: float = 0.5, bce_weight: float = 0.5, smooth: float = 1e-5
    ):
...
class SPDNLoss(nn.Module):
    """Custom SPDN loss combining multiple components."""
...
class PerceptualLoss(nn.Module):
    ...
    def __init__(
        self,
        layers: list = ["relu1_1", "relu2_1", "relu3_1"],
