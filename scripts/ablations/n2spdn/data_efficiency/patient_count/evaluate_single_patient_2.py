...
def main():
    override_config = {
        "evaluation": {"ablation": "patient_count/3_patients", "n_patients": 3}
    }
    ...
    n2n_metrics, n2n_denoised = evaluate_baseline(
        raw_image, reference, "n2n", override_config=override_config
    )
    ...
    n2v_metrics, n2v_denoised = evaluate_baseline(
        raw_image, reference, "n2v", override_config=override_config
    )
    ...
    n2s_metrics, n2s_denoised = evaluate_baseline(
        raw_image, reference, "n2s", override_config=override_config
    )
